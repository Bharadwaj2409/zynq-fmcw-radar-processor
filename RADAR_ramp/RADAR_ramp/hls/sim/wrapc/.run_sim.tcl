...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fmcw_ramp_gen.autotvin.dat"
	set constFileTvOut       "fmcw_ramp_gen.autotvout.dat"
	set constFileHdlTvIn     "fmcw_ramp_gen.autohdltvin.dat"
	set constFileHdlTvOut    "fmcw_ramp_gen.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
