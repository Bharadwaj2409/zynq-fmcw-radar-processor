...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fmcw_ramp_gen.autotvin_min_val.dat"
         "c.fmcw_ramp_gen.autotvin_max_val.dat"
         "c.fmcw_ramp_gen.autotvin_step_size.dat"
         "c.fmcw_ramp_gen.autotvin_enable.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fmcw_ramp_gen.autotvout_dac_stream_V_data_V.dat"
         "rtl.fmcw_ramp_gen.autotvout_dac_stream_V_keep_V.dat"
         "rtl.fmcw_ramp_gen.autotvout_dac_stream_V_strb_V.dat"
         "rtl.fmcw_ramp_gen.autotvout_dac_stream_V_last_V.dat"
         "rtl.fmcw_ramp_gen.autotvout_sync_trigger.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
