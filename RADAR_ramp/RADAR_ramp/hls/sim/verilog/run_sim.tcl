...
if {[file isfile fmcw_ramp_gen.autotvin.dat]} {
	file delete -force fmcw_ramp_gen.autotvin.dat
}

if {[file isfile fmcw_ramp_gen.autotvout.dat]} {
	file delete -force fmcw_ramp_gen.autotvout.dat
}
