...
set ip_vlnv xilinx.com:hls:fmcw_ramp_gen:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project RADAR_ramp
...
dict set report_options topmodule "fmcw_ramp_gen"
dict set report_options funcmodules {}
dict set report_options bindmodules {fmcw_ramp_gen_s_axi_control_s_axi fmcw_ramp_gen_regslice_both}
