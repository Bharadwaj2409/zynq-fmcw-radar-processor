...
HLS_SOURCES = ../../../../tb_fmcw_ramp_gen.cpp ../../../../fmcw_ramp_gen.cpp
...
$(ObjDir)/tb_fmcw_ramp_gen.o: ../../../../tb_fmcw_ramp_gen.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../tb_fmcw_ramp_gen.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_fmcw_ramp_gen.d

$(ObjDir)/fmcw_ramp_gen.o: ../../../../fmcw_ramp_gen.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../fmcw_ramp_gen.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=fmcw_ramp_gen $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fmcw_ramp_gen.d
