...
proc create_root_design { parentCell } {
  ...
  set ZmodDAC_ClkIn_0 [ create_bd_port -dir O ZmodDAC_ClkIn_0 ]
  ...
  set sZmodDAC_Reset_0 [ create_bd_port -dir O sZmodDAC_Reset_0 ]
...
\
  ...
  # Create instance: DAC_wrapper_0, and set properties
  set block_name DAC_wrapper
  set block_cell_name DAC_wrapper_0
  if { [catch {set DAC_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $DAC_wrapper_0 eq "" } {
  ...
  connect_bd_net -net DAC_wrapper_0_ZmodDAC_ClkIO_0  [get_bd_pins DAC_wrapper_0/ZmodDAC_ClkIO_0] \
  [get_bd_ports ZmodDAC_ClkIO_0]
  connect_bd_net -net DAC_wrapper_0_ZmodDAC_ClkIn_0  [get_bd_pins DAC_wrapper_0/ZmodDAC_ClkIn_0] \
  [get_bd_ports ZmodDAC_ClkIn_0]
  connect_bd_net -net DAC_wrapper_0_dZmodDAC_Data_0  [get_bd_pins DAC_wrapper_0/dZmodDAC_Data_0] \
  [get_bd_ports dZmodDAC_Data_0]
  connect_bd_net -net DAC_wrapper_0_sZmodDAC_CS_0  [get_bd_pins DAC_wrapper_0/sZmodDAC_CS_0] \
  [get_bd_ports sZmodDAC_CS_0]
  connect_bd_net -net DAC_wrapper_0_sZmodDAC_EnOut_0  [get_bd_pins DAC_wrapper_0/sZmodDAC_EnOut_0] \
  [get_bd_ports sZmodDAC_EnOut_0]
  connect_bd_net -net DAC_wrapper_0_sZmodDAC_Reset_0  [get_bd_pins DAC_wrapper_0/sZmodDAC_Reset_0] \
  [get_bd_ports sZmodDAC_Reset_0]
  connect_bd_net -net DAC_wrapper_0_sZmodDAC_SCLK_0  [get_bd_pins DAC_wrapper_0/sZmodDAC_SCLK_0] \
  [get_bd_ports sZmodDAC_SCLK_0]
  connect_bd_net -net DAC_wrapper_0_sZmodDAC_SetFS1_0  [get_bd_pins DAC_wrapper_0/sZmodDAC_SetFS1_0] \
  [get_bd_ports sZmodDAC_SetFS1_0]
  connect_bd_net -net DAC_wrapper_0_sZmodDAC_SetFS2_0  [get_bd_pins DAC_wrapper_0/sZmodDAC_SetFS2_0] \
  ...
  [get_bd_pins DAC_wrapper_0/sZmodDAC_SDIO_0]
  ...
  [get_bd_pins DAC_wrapper_0/SysClk100_0]
  ...
  [get_bd_pins DAC_wrapper_0/DAC_Clk_0]
  ...
  [get_bd_pins DAC_wrapper_0/reset_rtl]
